...
# Script generated for node Step Trainer Join
StepTrainerJoin_node1678712668552 = Join.apply(
    frame1=CustomerPrivacyJoin_node2,
    frame2=AmazonS3_node1678712397112,
    keys1=["serialNumber"],
    keys2=["serialNumber"],
    transformation_ctx="StepTrainerJoin_node1678712668552",
)

# Script generated for node Drop Fields
DropFields_node1678631456241 = DropFields.apply(
    frame=StepTrainerJoin_node1678712668552,
    paths=[
        "user",
        "timeStamp",
        "x",
...
StepTrainerTrusted_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://manish-s3-lake-house/step_trainer/trusted/",
        "partitionKeys": [],
    },
